...
<body class="body1"  ng-app="mainApp" ng-controller="mainController">
    ...
    <div class="block01" >
        <h1 class="caption01"><span style="background:#FEB225;color: white; padding: 0.3%">мастер</span>класс</h1>
        <div class="box_frame01">
            <div class="box01">
                <h1 style="padding: 5%;">3 стратегии,<br> сделавшие нас миллионерами на трендах 2017-2018гг</h1>
                <div class="subscribe_btn" style="background:#FEB225; text-align: center;"><a href="#" style="color: white" data-toggle="modal" data-target=#modal><h3>принять участие</h3></a></div>
            </div>
        </div>
    </div>
    <div class="block02">
        <h1 class="caption02" >до ближайшего мероприятия осталось</h1>
        <div class="mytimer">
        ...
        <h1 class="caption02">количество мест ограничено</h1>
    ...
    <div class="block01">
        <h1 class="caption01"><span style="background:#FEB225;color: white; padding: 0.3%"> для кого предназначен</span>мастер класс</h1>
        <div class="box_frame01">
            <div class="box01">
                <div class="slider">
    ...
    <div class="block03">
        <h1 class="caption01"><span style="background:#FEB225;color: white; padding: 0.3%">чего не будет</span>на нашем мастер классе</h1>
    ...
    <div class="block01" >
        <h1 class="caption01" style="margin-top: 20%"><span style="background:#FEB225;color: white; padding: 0.3%">Количество миллионеров в россии</span><br>увеличилось за прошлый год на 20%</h1>
        <div class="box_frame01">
